...
<div id='image' align='center'>
    <img width='70%' src='assets/algorithm1.png' alt='Image with algorithm'>
    <p><i>Абстрактная операция <a href='https://tc39.es/ecma262/multipage/abstract-operations.html#sec-toprimitive'>
        ToPrimitive()
    </a></i></p>
</div>
<br>
...
-   [_If_](https://tc39.es/ecma262/multipage/notational-conventions.html#sec-algorithm-conventions:~:text=written%20as%20an%20%E2%80%9C-,if,-%E2%80%9D%20predicate%20that%20conditions):
    нужен для разветвления шага на несколько подшагов, но только с выполненным условием истины -
    `true`.
-   [_Assert_](https://tc39.es/ecma262/multipage/notational-conventions.html#sec-algorithm-conventions:~:text=that%20begins%20with%20%E2%80%9C-,Assert,-%3A%E2%80%9D%20asserts%20an%20invariant):
    ...
    _всегда истинное_ инвариантное условие с одним искусственным разветвлением.

[На картинке](#example) представлен алгоритм, в котором присутствуют, как `If`, так и `Assert`
предикаты.
...
подразумевается то, в каком виде они реализованы и как используются.
